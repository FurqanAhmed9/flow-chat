    ...
    <main className="flex min-h-screen flex-col items-center justify-center bg-linear-to-br from-[#141e30] via-[#243b55] to-[#141e30] text-white p-6 relative overflow-hidden">
      ...
      <section className="z-10 text-center bg-black/60 backdrop-blur-xl border border-gray-700 rounded-3xl p-10 shadow-2xl max-w-lg w-full transform transition-transform hover:scale-[1.03] duration-300">
        <h1 className="text-5xl font-extrabold mb-4 tracking-wide drop-shadow-md">
          flow<span className="text-blue-500">chat...</span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          ...
          <Button
            asChild
            variant="outline"
            className="w-full sm:w-auto border-blue-600 text-white hover:bg-blue-600 hover:text-white text-lg font-semibold py-6 transition-all"
          >
